...
def ch_send_webhook(val0:str):
   if webhook_0 == True:
    ...
    try:
     webhook.post(
       username="Support",
       avatar_url="https://files.catbox.moe/6oxkxq.png",
       embeds=[
    {
      "title": f"Username: `{val0}` is available :white_check_mark:.",
      "timestamp": str(datetime.datetime.utcnow()),
      "footer": {
        "text": "github.com/dk6m"
      },
      "author": {
        "name": "Support - Username Found",
        "url": "https://github.com/dk6m",
        "icon_url": "https://files.catbox.moe/6oxkxq.png"
      },
      "thumbnail": {
        "url": "https://files.catbox.moe/6oxkxq.png"
      },
      "fields": [],
      "color": 16777215
    }
